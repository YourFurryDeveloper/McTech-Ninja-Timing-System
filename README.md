...
#### NOTE: You NEED to have port 49152 open (not forwarded) OPEN, on your network, or this will NOT work. Also, I HIGHLY reccomend using a private 5ghz network with no one else on it for the smoothest and most accurate experience. 2.4ghz works as well.
...
* /api (Serves the JSON files that contain info about the competition configuration, the obstacles, and runners. The data from this endpoint can be integrated into a custom app or website.)
